...
export class GrillaEmpresaService {
    ...
    //GET tipos de grillas
    getGrillasTiposByEjecutivo(ejecutivo: string): Observable<GrillaTipo[]> {
        return this.http.get<GrillaTipo[]>(`${this.baseUrl}/Empresas/api/grillaEmpresa/tipos?ejecutivo=${ejecutivo}`);
    }
    ...
    //GET grillas especiales
    getGrillasEspeciales(): Observable<GrillaDTO[]> {
        return this.http.get<GrillaDTO[]>(`${this.baseUrl}/Empresas/api/grillaEmpresa/especiales`);
    }
    /**
     * TEMPORARIO
     */
